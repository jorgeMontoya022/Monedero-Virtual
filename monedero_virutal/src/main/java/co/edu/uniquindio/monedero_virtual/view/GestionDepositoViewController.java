...
public class GestionDepositoViewController extends CoreViewController {
    ...
    GestionCuentasController cuentasController;
    ...
    void initialize() {
        ...
        cuentasController = new GestionCuentasController();
    ...
    private void onDeposit(ActionEvent event) {
        ...
        if(depositosController.realizarDeposito(deposito)){
            mostrarMensaje("Depósito exitoso!", "Se ha realizado un depósito de " + deposito.getMonto(),
    ...
    private void initDataBinding() {
        ...
        monederoColumn.setCellValueFactory(
                cellData -> new SimpleStringProperty(String.valueOf(cellData.getValue().getMonedero().getNombreMonedero())));
    ...
    private void initializeDataCombobox() {
        int idCliente = clienteLogueado.getId();
        cuentaComboBox.getItems().addAll(cuentasController.getCuentasUsuario(idCliente));
        monederoComboBox.getItems().addAll(cuentasController.getMonederosCliente(idCliente));
    }
